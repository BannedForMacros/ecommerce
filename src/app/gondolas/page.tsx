            ...
            >
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10.293 3.293a1 1 0 011.414 0l5.004 5.004a1 1 0 010 1.414l-5.004 5.004a1 1 0 11-1.414-1.414L13.586 10 10.293 6.707a1 1 0 010-1.414zM3 10a1 1 0 011-1h10.586a1 1 0 110 2H4a1 1 0 01-1-1z"
                    clipRule="evenodd"
                  />
                </svg>
              </Link>
...
/* ─────────────────────────────────────────────
   BLOQUE ILUSTRADO (extraído para claridad)
   ──────────────────────────────────────────── */
function IllustratedBlock() {
  return (
    <section className="relative mt-24 overflow-hidden">
      ...
      >
        <path
          d="M0 0h1200v90C980 120 820 120 600 90S220 60 0 90V0z"
          fill="#E7FAED"
        />
        <path
          d="M0 90h1200v90C980 210 820 210 600 180S220 150 0 180V90z"
          fill="#D1F2DF"
        />
      </svg>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-20 pb-28">
        ...
        <h2 className="text-emerald-600 font-extrabold text-3xl md:text-4xl text-center leading-tight mb-16">
          ¡Siempre buscamos <br className="hidden md:block" />
          lo mejor para ti!
        </h2>
...
function IllustratedCards() {
  const cards = [
    ...
    },
    {
      ...
      alt: 'Redes sociales',
      body: <>Síguenos en nuestras<br />redes sociales</>,
    },
  ] as const
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16">
      {cards.map(card => (
        <div
          key={card.alt}
          className="w-60 md:w-64 h-[26rem] bg-white rounded-2xl border border-gray-100 shadow-sm
        ...
        >
          ...
          <Image
            ...
            width={600}
            height={600}
            className="object-contain mx-auto w-56 h-56 md:w-64 md:h-64 lg:w-72 lg:h-72"
          />
        </div>
      ))}
    </div>
